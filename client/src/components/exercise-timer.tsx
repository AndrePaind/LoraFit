...
export default function ExerciseTimer({ exercise, onComplete, onSkip, sessionDuration }: ExerciseTimerProps) {
  ...
  // Calculate exercise duration based on session type - increased to 60s for 10min sessions
  const exerciseDuration = sessionDuration === 5 ? 40 : 60; // 5 min = 40s each, 10 min = 60s each
